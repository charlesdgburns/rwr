...
```{r Figure 2: Relative sampling variability}
...
Figure2 <- ggarrange(os_corrsHist, os_pvalHist,  rs_corrsHist,  rs_pvalHist, nrow=2, ncol=2, heights=c(4,4), labels=c('a','b','c','d'))

ggsave('figures/Figure2.png', 
       (Figure2),bg='transparent',  width = 20, height = 16, dpi = 900, units = "cm", device='png')
...
ggsave('figures/Figure2e.png', (NSedgeIterHist), bg='transparent', width=7, height=7, dpi=900, units='cm', device='png')
